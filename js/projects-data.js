...
const PROJECTS_DATA = [
  ...
  // Project 3 (2025): SHORT DOCUMENTARY: KHÁM PHÁ NGHỆ THUẬT HÁT BỘI
  {
    ...
    shortDesc: "Served as the Main Video Editor for a 4-minute mini-documentary produced as a Media Production course project. Responsible for structuring a concise yet compelling narrative from raw interview clips and B-roll. Handled precise cutting, audio cleanup, lower-thirds/titles, and color grading to deliver a broadcast-quality piece of micro-storytelling.",
    fullDesc: "Phim tài liệu ngắn (Mini-Documentary 4 phút) 'Khám Phá Nghệ Thuật Hát Bội' do kênh Sóng News sản xuất. Dự án tôn vinh nét đẹp nghệ thuật sân khấu truyền thống Việt Nam thông qua góc nhìn của các nghệ nhân gạo cội. Đảm nhiệm vai trò Main Video Editor phụ trách: Xây dựng cấu trúc kịch bản phóng sự, chọn lọc B-roll đắt giá, cân chỉnh màu sắc nghệ thuật đậm chất tuồng cổ và làm sạch âm thanh phỏng vấn hiện trường.",
    role: "Main Video Editor",
    course: "Media Course Project - Van Lang University",
    year: "2025",
  ...
  // Project 6 (2026): TALKSHOW: GÓC NHÌN SÁNG TẠO
  {
    ...
    category: "TALKSHOW",
    categoryLabel: "Multi-Cam Talkshow Production",
    shortDesc: "Served as the Main Video Editor for a Media Production course project, producing the talkshow episode 'Góc Nhìn Sáng Tạo'. Responsible for seamless multi-camera switching, dialogue audio cleanup, motion graphics integration (intro, lower-thirds, callouts), and color grading to deliver an engaging, TV-standard broadcast layout, optimized for live streaming standards.",
    fullDesc: "Tập Talkshow chuyên đề 'GÓC NHÌN SÁNG TẠO' do AURA Production sản xuất. Đảm nhận vai trò Main Video Editor phụ trách: Dựng đa góc máy (Multi-Camera Switching), thiết kế & đồng bộ đồ họa động (Motion Graphics: Intro, Lower-thirds, Callouts), lọc nhiễu âm thanh đối thoại hiện trường và xuất bản theo tiêu chuẩn phát sóng truyền hình & livestream.",
    role: "Main Video Editor & Colorist",
    course: "Media Course Project - Van Lang University",
    year: "2026",
    client: "AURA Production / Góc Nhìn Sáng Tạo",
