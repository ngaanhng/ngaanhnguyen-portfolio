...
const PROJECTS_DATA = [
  ...
  // Project 2 (2025): TALKSHOW: NHÀ TRUYỀN THÔNG HỌC TÂM LÝ
  {
    ...
    shortDesc: "Served as the Main Video Editor for a Media Production course project, producing a multi-camera talkshow episode. Responsible for seamless multi-cam switching, dialogue audio cleanup, motion graphics integration (intro, lower-thirds, callouts), and color grading to deliver an engaging, TV-standard broadcast layout, optimized for live streaming standards.",
    fullDesc: "Tập Talkshow chuyên đề 'Góc Nhìn Sáng Tạo: Nhà Truyền Thông Học Tâm Lý' (Khách mời: Đại diện PEPSI - Từ Phương, Nhà Phân tích Tâm lý - Tấn Hy, Host/MC - Thanh Nga). Đảm nhận vai trò Main Video Editor phụ trách: Dựng đa góc máy (Multi-Camera Switching), thiết kế & đồng bộ đồ họa động (Motion Graphics: Intro, Lower-thirds, Callouts), lọc nhiễu âm thanh đối thoại và xuất bản theo tiêu chuẩn phát sóng truyền hình & livestream.",
    role: "Main Video Editor, Cameraman",
    course: "Media Course Project - Van Lang University",
    year: "2025",
  ...
  // Project 4 (2025): INTERVIEW: PHỎNG VẤN KHÁCH HÀNG CANTON FAIR 137
  {
    ...
    shortDesc: "Served as the Main Video Editor & Interview Content Producer for the customer interview series at Canton Fair 137 (Phase 1, Guangzhou) organized by ADENZ Travel. Managed on-site interview cutting, audio cleanup, dynamic lower-thirds, and customer testimonial pacing.",
    fullDesc: "Dự án video phỏng vấn cảm nhận khách hàng & đại biểu tham dự Hội chợ Thương mại Quốc tế Canton Fair 137 (Đợt 1 - Quảng Châu) do ADENZ Travel tổ chức. Đảm nhiệm vai trò Main Video Editor phụ trách: Dựng phỏng vấn hiện trường, cắt gọt chia sẻ của khách hàng súc tích, xử lý âm thanh tiếng ồn hội chợ, thiết kế bảng tên đồ họa (Lower-Thirds) và chèn B-roll toàn cảnh sự kiện.",
    role: "Main Video Editor",
  ...
  // Project 5 (2026): MV REMAKE “HẸN LẦN SAU”
  {
    ...
    shortDesc: "Lead Video Editor & Colorist for MAYDAYs' Music Video 'Hẹn Lần Sau' Remake as a Media Production course project, focusing on narrative editing, pacing, and color styling aligned with the music's rhythm.",
  ...
  // Project 7 (2026): INTERVIEW: BẠN CÓ QUAN TÂM VỀ BẤT ĐỘNG SẢN?
  {
    ...
    shortDesc: "Main Video Editor for the social survey interview 'Bạn Có Quan Tâm Về Bất Động Sản?'. Managed outdoor interview cutting, voice audio cleanup, graphic callouts, and engaging visual transitions.",
    fullDesc: "Dự án video phỏng vấn khảo sát đường phố 'Bạn Có Quan Tâm Về Bất Động Sản? - Đâu là nơi bạn muốn đầu tư cho tương lai của mình?'. Đảm nhận vai trò Main Video Editor & Motion Graphics: Xử lý cắt ghép đối thoại hiện trường súc tích, chèn B-roll phối cảnh đô thị sinh động, thiết kế bảng câu hỏi đồ họa (Graphic Callout Cards) và cân bằng âm thanh giọng nói ngoài trời.",
    role: "Main Video Editor, Cameraman",
    course: "Media Course Project - Van Lang University",
    year: "2026",
  ...
  // Project 8 (2026): INTERVIEW: PHỎNG VẤN KHÁCH HÀNG MỤC TIÊU (LITTLE SPOON)
  {
    ...
    shortDesc: "Main Video Editor & Content Producer for the target customer interview 'Mô hình: Quán ăn cho bé - Little Spoon'. Handled on-site parent interview cutting, voice audio cleanup, lower-thirds branding, and customer insight storytelling.",
    fullDesc: "Dự án video phỏng vấn khảo sát khách hàng mục tiêu (Phụ huynh có con nhỏ 3-6 tuổi) cho Đồ án Khởi nghiệp 'Mô hình Quán ăn cho bé - Little Spoon' (Nhóm 2 - Khoa QHCC & Truyền thông, Đại học Văn Lang). Đảm nhận vai trò Main Video Editor phụ trách: Dựng phỏng vấn thực tế với phụ huynh, cô đọng nhu cầu dinh dưỡng cho trẻ nhỏ, thiết kế bảng tên đồ họa Lower-Thirds theo nhận diện Little Spoon và lồng ghép B-roll hình ảnh món ăn hữu cơ & không gian vui chơi cho bé.",
    role: "Main Video Editor & Content Producer, Cameraman",
  ...
  // Project 10 (2026): MY PHOTO GALLERY
  {
    id: "project-10",
    num: "Project - 10",
    title: "MY PHOTO GALLERY",
    category: "PHOTO",
    categoryLabel: "Photography & Visual Media Gallery",
    shortDesc: "All images presented here were produced for my personal project.",
    fullDesc: "All images presented here were produced for my personal project.",
    role: "Photographer",
    ...
    badgeColor: "bg-pink-500/20 text-pink-300 border-pink-500/30",
    previewImage: "assets/images/gallery/gallery_17.jpg",
    isGallery: true,
    
    photoCollection: [
      {
        id: "photo-1",
        title: "Tác Phẩm Nhiếp Ảnh 01",
        category: "Bố Cục & Không Gian",
        tag: "Tác Phẩm Nhiếp Ảnh 01",
        desc: "Khai thác chiều sâu không gian, cân bằng bố cục và đường dẫn thị giác trong tác phẩm nhiếp ảnh thực tế.",
        img: "assets/images/gallery/gallery_1.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-2",
        title: "Tác Phẩm Nhiếp Ảnh 02",
        category: "Hiện Trường & Sự Kiện",
        tag: "Tác Phẩm Nhiếp Ảnh 02",
        desc: "Làm chủ ánh sáng hiện trường tự nhiên, giữ trọn chi tiết vùng sáng tối và sắc thái chân thực.",
        img: "assets/images/gallery/gallery_2.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-3",
        title: "Tác Phẩm Nhiếp Ảnh 03",
        category: "Hiện Trường & Sự Kiện",
        tag: "Tác Phẩm Nhiếp Ảnh 03",
        desc: "Bắt trọn khoảnh khắc tương tác tự nhiên, phản ánh trọn vẹn nhịp sống và tinh thần phóng sự thực tế.",
        img: "assets/images/gallery/gallery_3.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-4",
        title: "Tác Phẩm Nhiếp Ảnh 04",
        category: "Bố Cục & Không Gian",
        tag: "Tác Phẩm Nhiếp Ảnh 04",
        desc: "Góc máy mở rộng làm nổi bật sự hài hòa giữa kiến trúc, tỷ lệ khung hình và sắc thái không gian.",
        img: "assets/images/gallery/gallery_4.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-5",
        title: "Tác Phẩm Nhiếp Ảnh 05",
        category: "Chân Dung & Cảm Xúc",
        tag: "Tác Phẩm Nhiếp Ảnh 05",
        desc: "Đặc tả thần thái, biểu cảm sâu sắc và ánh sáng tương phản tinh tế tạo cảm xúc lắng đọng.",
        img: "assets/images/gallery/gallery_5.jpg",
        aspect: "portrait"
      },
      {
        id: "photo-6",
        title: "Tác Phẩm Nhiếp Ảnh 06",
        category: "Sáng Tạo Thị Giác",
        tag: "Tác Phẩm Nhiếp Ảnh 06",
        desc: "Tìm kiếm góc tiếp cận mới lạ, tạo điểm nhấn thị giác khác biệt và cuốn hút người xem.",
        img: "assets/images/gallery/gallery_6.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-7",
        title: "Tác Phẩm Nhiếp Ảnh 07",
        category: "Chi Tiết & Nghệ Thuật",
        tag: "Tác Phẩm Nhiếp Ảnh 07",
        desc: "Tập trung độ nét và độ tương phản vi mô, tôn vinh chất liệu và đường nét tinh xảo.",
        img: "assets/images/gallery/gallery_7.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-8",
        title: "Tác Phẩm Nhiếp Ảnh 08",
        category: "Đời Sống & Văn Hóa",
        tag: "Tác Phẩm Nhiếp Ảnh 08",
        desc: "Ghi lại nét sinh hoạt đời thường giàu chất thơ và đậm đà bản sắc văn hóa địa phương.",
        img: "assets/images/gallery/gallery_8.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-9",
        title: "Tác Phẩm Nhiếp Ảnh 09",
        category: "Chân Dung & Cảm Xúc",
        tag: "Tác Phẩm Nhiếp Ảnh 09",
        desc: "Ghi lại khoảnh khắc nụ cười và năng lượng tích cực với độ mở khẩu và bắt nét tối ưu.",
        img: "assets/images/gallery/gallery_9.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-10",
        title: "Tác Phẩm Nhiếp Ảnh 10",
        category: "Sáng Tạo Thị Giác",
        tag: "Tác Phẩm Nhiếp Ảnh 10",
        desc: "Hậu kỳ phân loại màu sắc đồng bộ, tối ưu hóa thị giác cho các nền tảng truyền thông số.",
        img: "assets/images/gallery/gallery_10.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-11",
        title: "Tác Phẩm Nhiếp Ảnh 11",
        category: "Bố Cục & Không Gian",
        tag: "Tác Phẩm Nhiếp Ảnh 11",
        desc: "Bố cục tỷ lệ vàng hài hòa, tạo ấn tượng thị giác toàn cảnh khoáng đạt và chuyên nghiệp.",
        img: "assets/images/gallery/gallery_11.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-12",
        title: "Tác Phẩm Nhiếp Ảnh 12",
        category: "Nghệ Thuật & Bối Cảnh",
        tag: "Tác Phẩm Nhiếp Ảnh 12",
        desc: "Bố trí ánh sáng có chủ đích làm nổi bật không gian và sắc thái cảm xúc của đối tượng.",
        img: "assets/images/gallery/gallery_12.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-13",
        title: "Tác Phẩm Nhiếp Ảnh 13",
        category: "Hiện Trường & Sự Kiện",
        tag: "Tác Phẩm Nhiếp Ảnh 13",
        desc: "Bắt trọn diễn biến tự nhiên tại hiện trường với tốc độ màn trập nhanh và độ nét cao.",
        img: "assets/images/gallery/gallery_13.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-14",
        title: "Tác Phẩm Nhiếp Ảnh 14",
        category: "Bố Cục & Không Gian",
        tag: "Tác Phẩm Nhiếp Ảnh 14",
        desc: "Tận dụng các đường dẫn thị giác và đường thẳng kiến trúc tạo chiều sâu ấn tượng.",
        img: "assets/images/gallery/gallery_14.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-15",
        title: "Tác Phẩm Nhiếp Ảnh 15",
        category: "Chân Dung & Cảm Xúc",
        tag: "Tác Phẩm Nhiếp Ảnh 15",
        desc: "Khắc họa chiều sâu tâm trạng và biểu cảm sinh động qua góc máy cận cảnh tinh tế.",
        img: "assets/images/gallery/gallery_15.jpg",
        aspect: "portrait"
      },
      {
        id: "photo-16",
        title: "Tác Phẩm Nhiếp Ảnh 16",
        category: "Sáng Tạo Thị Giác",
        tag: "Tác Phẩm Nhiếp Ảnh 16",
        desc: "Khai thác tương phản màu sắc và đối xứng khung hình tạo sức hút thị giác mạnh mẽ.",
        img: "assets/images/gallery/gallery_16.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-17",
        title: "Tác Phẩm Nhiếp Ảnh 17",
        category: "Chi Tiết & Nghệ Thuật",
        tag: "Tác Phẩm Nhiếp Ảnh 17",
        desc: "Tập trung khai thác dải sáng tối (Dynamic Range) và kết cấu bề mặt sống động.",
        img: "assets/images/gallery/gallery_17.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-18",
        title: "Tác Phẩm Nhiếp Ảnh 18",
        category: "Đời Sống & Văn Hóa",
        tag: "Tác Phẩm Nhiếp Ảnh 18",
        desc: "Bắt trọn khoảnh khắc đời thường mộc mạc và chân thực mang đậm hơi thở cuộc sống.",
        img: "assets/images/gallery/gallery_18.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-19",
        title: "Tác Phẩm Nhiếp Ảnh 19",
        category: "Hiện Trường & Sự Kiện",
        tag: "Tác Phẩm Nhiếp Ảnh 19",
        desc: "Cân bằng ánh sáng ban ngày tự nhiên và sắc độ tươi tắn tràn đầy sức sống.",
        img: "assets/images/gallery/gallery_19.jpg",
        aspect: "landscape"
      },
      {
        id: "photo-20",
        title: "Tác Phẩm Nhiếp Ảnh 20",
        category: "Chân Dung & Cảm Xúc",
        tag: "Tác Phẩm Nhiếp Ảnh 20",
        desc: "Kết hợp bố cục đương đại và xử lý màu sắc tinh tế cho tác phẩm chân dung nghệ thuật.",
        img: "assets/images/gallery/gallery_20.jpg",
        aspect: "portrait"
      },
      {
        id: "photo-21",
        title: "Tác Phẩm Nhiếp Ảnh 21",
        category: "Bố Cục & Không Gian",
        tag: "Tác Phẩm Nhiếp Ảnh 21",
        desc: "Góc máy toàn cảnh khoáng đạt, cân xứng tỷ lệ và mở rộng tầm nhìn thị giác.",
        img: "assets/images/gallery/gallery_21.jpg",
        aspect: "landscape"
      }
    ]
  }
...
const PROFILE_DATA = {
  ...
  skills: [
    ...
    { name: "Tìm kiếm tốt thông tin", level: "Tốt", icon: "search", desc: "Có khả năng research, tổng hợp thông tin, tư duy logic" }
  ],
  contact: {
    phone: "0962468650",
